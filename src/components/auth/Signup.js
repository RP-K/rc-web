...
const Signup = () => {
  ...
  >
    ...
    <div className='text-center'>
        <p className='text-2xl'>Rain Computing</p></div>
    <div className='text-center'>
    ...
    <div className="mb-4">
      ...
      <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
       id="firstname"
        type="text" 
        {...register('firstname', valitation.firstname) }
        />
    </div>
    ...
    <div className="mb-4">
      ...
      id="lastname" 
      type="text"
      {...register('lastname', valitation.lastname) }
       />
        <small className="text-red-700">
    ...
    <div className="mb-4">
      ...
      <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
       id="email" 
       type="email" {...register('email', valitation.email) }
        />
         <small className="text-red-700">
    ...
    <div className="mb-6">
      ...
      id="password"
       type="password" 
       {...register('password', valitation.password) }
       />
        <small className="text-red-700">
